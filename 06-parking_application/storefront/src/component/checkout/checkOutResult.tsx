...
export default function CheckOutResult({ ticket, onBack, onStart, success }: CheckOnResultProps) {
        ...
        <div className="flex flex-col items-center justify-center gap-4">
            <div className="min-w-72 bg-gray-200 px-4 py-4">
                ...
                <div className="text-base py-4 px-4">
                    ...
                    <div className="flex justify-between">
                        <p>Check-in Time</p>
                        <p className="italic">{GeneralUtil.formatTimeFromString(ticket.createdAt)}</p>
                    </div>
                    {success === null ?
                        (<div className="flex justify-between">
                            <p>Current Time</p>
            ...
            <div className="flex gap-4">
                {success === null &&
                    <button
                        ...
                        className="bg-yellow-600 text-gray-50 uppercase font-semibold min-w-32 px-4 py-2 rounded-xl cursor-pointer"
                    >
                        <p className="font-semibold uppercase text-sm text-white">Stop</p>
                    </button>
                }
                <button 
